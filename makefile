...
DOCKER_SET_DEBUG_ENV_VARS := \
	...
	export DIRECTORY_CH_SEARCH_COMPANIES_HOUSE_API_KEY=debug; \
	export DIRECTORY_CH_SEARCH_COMPANIES_HOUSE_CLIENT_ID=debug; \
	export DIRECTORY_CH_SEARCH_COMPANIES_HOUSE_CLIENT_SECRET=debug
