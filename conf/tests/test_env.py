        ...
        'postgres': [
            {
                ...
                'instance_guid': '1234',
                'instance_name': 'directory-companies-house-search-db',
                'label': 'postgres',
                'name': 'directory-companies-house-search-db',
                'plan': 'medium-ha',
                'provider': None,
        ...
        'redis': [
            {
                ...
                'instance_guid': '4567',
                'instance_name': 'directory-companies-house-search-redis-small',
                'label': 'redis',
                'name': 'directory-companies-house-search-redis-small-ha-6',
                'plan': 'small-ha',
                'provider': None,
                'syslog_drain_url': None,
...
def vcap_application():
    data = {
        ...
        'application_name': 'directory-companies-house-search',
        'application_uris': ['www.example.com'],
        'cf_api': 'https://api.example.com',
        'limits': {'fds': 1},
        'name': 'directory-companies-house-search',
